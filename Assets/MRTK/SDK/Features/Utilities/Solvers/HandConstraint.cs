...
namespace Microsoft.MixedReality.Toolkit.Utilities.Solvers
{
    ...
    public class HandConstraint : Solver
    {
        ...
        //MODIFIED TO RETURN LAST DETECTED CONTROLLER INSTEAD OF FIRST
        /// </summary>
        ...
        {
            IMixedRealityController controller = null;// MODIFIED CODE
            foreach (IMixedRealityController c in CoreServices.InputSystem.DetectedControllers)
            {
                ...
                {
                    controller = c; //MODIFIED CODE
                    //return c;     //ORIGINAL CODE
                }
            }
            return controller;  //MODIFIED CODE
        ...
        protected override void OnEnable()
        {
            ...
            trackedController = null;
            OnLastHandLost.Invoke();
            //OnHandDeactivate.Invoke(); // This line has been commented out to stop unwanted behaviour
        }
